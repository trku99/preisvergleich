  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[
          { icon: "📝", title: "Blog", desc: "Blog yazıları" },
          { icon: "📰", title: "Haberler", desc: "Site haberleri" },
          { icon: "❓", title: "SSS", desc: "Sık sorulan sorular" },
          { icon: "📄", title: "Statik Sayfalar", desc: "Hakkımızda, İletişim" },
          { icon: "🆘", title: "Yardım", desc: "Yardım dökümanları" },
        ].map((item) => (
