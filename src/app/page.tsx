    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-16 sm:py-24 text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl">
          ...
          <br />
          <span className="text-blue-600">in der Schweiz</span>
        </h1>
      ...
      <section className="pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="rounded-xl border bg-white p-6 text-center">
            ...
            <h3 className="font-semibold text-zinc-900">Echtzeit-Preise</h3>
            <p className="mt-2 text-sm text-zinc-500">Preise werden alle 6 Stunden aktualisiert</p>
          </div>
          <div className="rounded-xl border bg-white p-6 text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 mb-4">
              <svg className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            <h3 className="font-semibold text-zinc-900">Preisvergleich</h3>
            <p className="mt-2 text-sm text-zinc-500">Alle Shops auf einen Blick</p>
          </div>
          <div className="rounded-xl border bg-white p-6 text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 mb-4">
              <svg className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            <h3 className="font-semibold text-zinc-900">Preisalarm</h3>
            <p className="mt-2 text-sm text-zinc-500">Benachrichtigung bei Preisänderungen</p>
          </div>
        </div>
      </section>
    </div>
